...
export const Sigil = ({ note, sigilSize, scaleNotes }) => {
    if (note[1] === "#") {
    ...
    var inScale = false
    if (scaleNotes.scaleNotes.includes(letter)) {
        inScale = true
    }
        ...
        return (
            <div className="relative select-none" style={{ width: sigilSize, height: sigilSize }} onClick={() => handleClick(note, inScale)} >
                ...
                <span className=" absolute flex inset-0 items-end justify-center text-shadow-emerald-500 font-bold font-serif z-20"
                    ...
                    {!inScale && (<div className="absolute rounded-full bg-black opacity-60 z-50"
