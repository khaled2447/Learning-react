...
export const SigilRoot = ({sigil, onClick, note, sigilSize}) => {
    ...
    if (isPressed){
        return(
            <div className="relative select-none" style={{ width: sigilSize, height: sigilSize }}  onClick={() => handleClick(note)} >
                ...
                <div className="absolute inset-0 flex items-center justify-center z-20">
                    ...
                    {isVisible && (<span className="absolute inline-flex h-full w-full animate-ping rounded-full 
